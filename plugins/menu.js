...
⌬ ɴᴏᴍᴏʀ : %name
⌬ ʀᴏʟᴇ : %role
⌬ ʟᴇᴠᴇʟ : %level (%exp / %maxexp) %xp4levelup
 ᴛᴏᴛᴀʟ xᴘ : %totalexp XP
...
⌬ ᴠᴇʀsɪᴏɴ : %version
⌬ ᴘʀᴇғɪx ᴜsᴇᴅ : *[ %p ]*
⌬ ᴅᴀᴛᴀʙᴀsᴇ : %rtotalreg dari %totalreg 
⌬ ᴍᴇᴍᴏʀʏ ᴜsᴇᴅ : ${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB
*•━━ ❮❮ DETAIL USER ❯❯ ━━•*
⌬ ᴘᴇɴɢɢᴜɴᴀ :  %name 
⌬ ʟɪᴍɪᴛ : %limit / day
⌬ sᴛᴀᴛᴜs : User
...
await conn.sendFile(m.chat, 'https://telegra.ph/file/dc5a67d724b016574129b.jpg', 'menu.jpg', text, ftroli)**/
    ...
    conn.reply(m.chat, 'ᴍᴀᴀғ, ᴍᴇɴᴜ sᴇᴅᴀɴɢ ᴇʀᴏʀ', m)
    throw e
  }
}
handler.help = ['menu']
